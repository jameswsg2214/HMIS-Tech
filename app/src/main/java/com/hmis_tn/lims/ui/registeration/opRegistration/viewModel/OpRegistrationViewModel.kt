package com.hmis_tn.lims.ui.registeration.opRegistration.viewModel
...
/*
    ...
    fun quickRegistrationSaveList(requestRegistration: RegistrationUatSaveRequest, PatientNameRetrofitCallback: RetrofitCallback<QuickRegistrationSaveResponseModel>
    ) {
    ...
    fun quickRegistrationUsingOldpinSaveList(requestRegistration: QuickRegWItholdpinSaveReq, PatientNameRetrofitCallback: RetrofitCallback<QuickRegistrationSaveResponseModel>
    ) {
        val userDataStoreBean = userDetailsRoomRepository?.getUserDetails()
    ...
    fun quickRegistrationUpdateformQuick(requestRegistration: QuickRegistrationUpdateRequest, updateQuickRegistrationRetrofitCallback: RetrofitCallback<QuickRegistrationUpdateResponseModel>
    ) {
        val userDataStoreBean = userDetailsRoomRepository?.getUserDetails()
        ...
        apiService?.updateQuickRegistrationFromQuick(AppConstants.ACCEPT_LANGUAGE_EN,
            AppConstants.BEARER_AUTH + userDataStoreBean?.access_token,
            userDataStoreBean?.uuid!!, facility_id!!,
            requestRegistration
        )?.enqueue(RetrofitMainCallback(updateQuickRegistrationRetrofitCallback))
    ...
    fun quickRegistrationUpdateformOPcorrection(requestRegistration: OpCorrectionRequest, updateQuickRegistrationRetrofitCallback: RetrofitCallback<QuickRegistrationUpdateResponseModel>
    ) {
        val userDataStoreBean = userDetailsRoomRepository?.getUserDetails()
        ...
        apiService?.updateQuickRegistrationFromOpCorrection(AppConstants.ACCEPT_LANGUAGE_EN,
            AppConstants.BEARER_AUTH + userDataStoreBean?.access_token,
            userDataStoreBean?.uuid!!, facility_id!!,
            requestRegistration
        )?.enqueue(RetrofitMainCallback(updateQuickRegistrationRetrofitCallback))
    ...
    fun quickRegistrationUpdateformQuick(requestRegistration: QuickRegistrationUpdateRequestWitholdPin, updateQuickRegistrationRetrofitCallback: RetrofitCallback<QuickRegistrationUpdateResponseModel>
    ) {
        val userDataStoreBean = userDetailsRoomRepository?.getUserDetails()
    ...
    fun getAll(teblename: String, covidPeriodResponseCallback: RetrofitCallback<GetAllResponseModel>) {
        if (!Utils.isNetworkConnected(getApplication())) {
            errorText.value = getApplication<Application>().getString(R.string.no_internet)
            return
        }
    ...
    fun getCommunity(tablename:String,specimenListRetrofitCallBack:RetrofitCallback<ResponseSpicemanType>)
    {
        if (!Utils.isNetworkConnected(getApplication())) {
            errorText.value = getApplication<Application>().getString(R.string.no_internet)
            return
  ...
  //      progress.value = 0
    ...
    fun getAllDepartment( req: GetAllDepartmentRequest?,
    ...
    fun getAllSchema( req: SchemaRequest?,
  ...
  //      progress.value = 0
    ...
    fun searchPatient(searchPatientRequestModelCovid: SearchPatientRequestModelCovid,
    ...
    fun getSession(facilityId: Int, sessionResponseCallback: RetrofitCallback<ResponseSesionModule>) {
    ...
    fun getActivitySession(facilityId: Int, activitysessionResponseCallback: RetrofitCallback<ResponseActivitySession>) {
   ...
   //     progress.value = 0
        ...
        apiService?.getActivitySession("en",
            AppConstants.BEARER_AUTH +userDataStoreBean?.access_token,
            userDataStoreBean?.uuid!!,
            facilityId
    ...
    fun getActivityRole(facilityId: Int, activityPrivilageRetrofitCallback: RetrofitCallback<QuickelementRoleResponseModel>) {
        ...
        apiService?.getRoleControlQuick("en",
            AppConstants.BEARER_AUTH +userDataStoreBean?.access_token,
            userDataStoreBean?.uuid!!,
            facilityId,2
