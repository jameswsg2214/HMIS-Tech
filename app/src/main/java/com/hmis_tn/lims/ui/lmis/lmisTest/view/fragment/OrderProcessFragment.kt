...
class OrderProcessFragment : Fragment(),RejectDialogFragment.OnLabTestRefreshListener {
    ...
    private var mAdapter: OrderProcessMobAdapter? = null
...
*/
        ...
        if (args == null) {
            ...
            if (favouriteData[0].test_master.value_type_master.code != AppConstants.ANALYTECODE) {
                ...
                binding!!.testName!!.text = favouriteData[0].test_master.name
...
//                    }
        ...
        mAdapter?.setOnCommandClickListener(object : OrderProcessMobAdapter.OnCommandClickListener {
