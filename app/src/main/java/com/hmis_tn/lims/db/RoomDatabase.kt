...
abstract class RoomDatabase : androidx.room.RoomDatabase() {
    ...
    companion object {
        private var INSTANCE: com.hmis_tn.lims.db.RoomDatabase? = null
         ...
         * @return
         */
        fun getInstance(context: Context): com.hmis_tn.lims.db.RoomDatabase? {
            if (INSTANCE == null) {
                    ...
                    if (INSTANCE == null) {
                        INSTANCE =
                            Room.databaseBuilder(
                                ...
                                com.hmis_tn.lims.db.RoomDatabase::class.java, "hmis_doctor_db"
                            )
